...
def billing_cycle_period_card(stage_callback):
    ...
    with PlaywrightManager() as page:
        try:
            ...
            # Verify 6 pages were successfully printed and recorded
            ...
            expect(print_history_page.complimentary_pages_value).to_contain_text(expected_pages_after_first_print, timeout=30000)
            ...
            # Send RTP with total 15 pages printed
            common.send_rtp_devicestatus(
                entity_id=printer_data.entity_id,
                cloud_id=printer_data.cloud_id,
                device_uuid=printer_data.device_uuid,
            ...
            page.wait_for_timeout(5000)
            # Verify cumulative total of 15 pages printed via Gemini API
            sub_data = common.subscription_data_from_gemini(sub_id)
